...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testIndex()
    {
        ...
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::indexAction', $this->client->getRequest()->attributes->get('_controller'));
        ...
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::showAction', $this->client->getRequest()->attributes->get('_controller'));
    ...
    public function testShow()
    {
        ...
        $crawler = $this->client->click($link);
        $this->assertEquals('Ens\JobeetBundle\Controller\CategoryController::showAction', $this->client->getRequest()->attributes->get('_controller'));
