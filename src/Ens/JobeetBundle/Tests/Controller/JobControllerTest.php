...
class JobControllerTest extends WebTestCase
{
    ...
    public function jobForm()
    {
        ...
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::newAction',
        ...
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::createAction',
            $this->client->getRequest()->attributes->get('_controller'));
        $this->client->followRedirect();
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::previewAction',
            $this->client->getRequest()->attributes->get('_controller'));
    }
    /**
     * @test
  ...
  /*
    ...
    public function extendJob()
    {
        ...
        $this->assertEquals($job->getExpiresAt()->format('y/m/d'), date('y/m/d', time() + 86400 * 30));
    }
    /**
     * Aux create job
     *
